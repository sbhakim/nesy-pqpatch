# ADR-002: L3 implemented as single-file `javac` compile, not containerized
Maven/Gradle build + test suite

**Status:** accepted (session-scoped; supersede when Phase 6 corpus apps ship
real build descriptors and test suites)
**Date:** 2026-07-11
